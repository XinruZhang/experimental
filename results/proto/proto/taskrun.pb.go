...
var file_taskrun_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x74, 0x68, 0x22, 0x9a, 0x02, 0x0a, 0x0d, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e,
	...
	0x65, 0x22, 0xc5, 0x02, 0x0a, 0x09, 0x53, 0x74, 0x65, 0x70, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e,
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x44, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72, 0x6f,
...
var file_taskrun_proto_depIdxs = []int32{
	...
	10, // 14: tekton.pipeline.v1.StepState.waiting:type_name -> tekton.pipeline.v1.ContainerStateWaiting
	11, // 15: tekton.pipeline.v1.StepState.running:type_name -> tekton.pipeline.v1.ContainerStateRunning
	12, // 16: tekton.pipeline.v1.StepState.terminated:type_name -> tekton.pipeline.v1.ContainerStateTerminated
	16, // 17: tekton.pipeline.v1.ContainerStateRunning.started_at:type_name -> google.protobuf.Timestamp
	16, // 18: tekton.pipeline.v1.ContainerStateTerminated.started_at:type_name -> google.protobuf.Timestamp
	16, // 19: tekton.pipeline.v1.ContainerStateTerminated.finished_at:type_name -> google.protobuf.Timestamp
